  ...
  <div id="main">
    <v-layout mt-4>
      <v-card tile width="100%">
        ...
        <v-divider class="brand"></v-divider>
        <v-layout wrap>
          <v-flex xs12 sm4 xl3>
                    ...
                    <v-layout justify-center>
                      <v-tooltip bottom>
                        <template v-slot:activator="{ on }">
                          <v-icon color="green" v-on="on">mdi-eye-circle</v-icon>
                        </template>
          ...
          <v-flex xs12 sm8 xl9 id="comment-border">
            <v-divider class="brand hidden-sm-and-up"></v-divider>
            <v-card tile flat height="100%">
              <v-card-text style class="mb-12">
                <v-card flat tile v-if="comments.length == 0">Be the first to comment...</v-card>
