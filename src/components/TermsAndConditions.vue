<template>
  <div class="my-6">
    ...
    <p>
      ...
      an agreement between Website Operator (&quot;Website Operator&quot;,
    ...
    <p>
      ...
      you are at least 13 years of age. If you create an account on the Website,
      ...
      obligation to, monitor and review new accounts before you may sign in and
      use our Services. Providing false contact information of any kind may
      result in the termination of your account. You must immediately notify us
    ...
    <p>
      ...
      you submit on the Website in the course of using the Service. You shall
      ...
      to use of all submitted Content. We may monitor and review Content on the
      Website submitted or created using our Services by you. Unless
      specifically permitted by you, your use of the Website does not grant us
    ...
    <p>
      ...
      Website Operator, its affiliates, officers, directors, employees, agents,
      ...
      Website Operator has been advised as to the possibility of such damages or
      could have foreseen such damages. To the maximum extent permitted by
      applicable law, the aggregate liability of Website Operator and its
    ...
    <p>
      ...
      them as a result of or relating to your Content, your use of the Website
    ...
    <p>
      ...
      procedural laws of Nigeria without regard to its rules on conflicts or
      choice of law and, to the extent applicable, the laws of Nigeria. The
      exclusive jurisdiction and venue for actions related to the subject matter
      hereof shall be the state and federal courts located in Nigeria, and you
